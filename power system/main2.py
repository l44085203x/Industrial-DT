...
def load_dataset2(path, nWindow, nPredict, nInterval, nc, train_Partial):
    ...
    sheet2 = workbook.sheet_by_name('PID_V_')
    sheet3 = workbook.sheet_by_name('DeltaF_')
    sheet4 = workbook.sheet_by_name('DeltaV_')
    sheet5 = workbook.sheet_by_name('DeltaLoad_')
    sheet6 = workbook.sheet_by_name('DeltaP_')
    sheet7 = workbook.sheet_by_name('Frequency_')
    ...
    for i in range(nEpoch):
        ...
        PID_V_ = np.array(sheet2.col_values(i, 1, nTime + 1))
        DeltaF_ = np.array(sheet3.col_values(i, 1, nTime + 1))
        DeltaV_ = np.array(sheet4.col_values(i, 1, nTime + 1))
        DeltaLoad_ = np.array(sheet5.col_values(i, 1, nTime + 1))
        DeltaP_ = np.array(sheet6.col_values(i, 1, nTime + 1))
        Frequency_ = np.array(sheet7.col_values(i, 1, nTime + 1))
        Voltage_ = np.array(sheet8.col_values(i, 1, nTime + 1))

        # PID_F_ = np.convolve(PID_F_, np.ones(nSmooth)) / nSmooth
        # PID_V_ = np.convolve(PID_V_, np.ones(nSmooth)) / nSmooth
        # DeltaF_ = np.convolve(DeltaF_, np.ones(nSmooth)) / nSmooth
        # DeltaV_ = np.convolve(DeltaV_, np.ones(nSmooth)) / nSmooth
        # DeltaLoad_ = np.convolve(DeltaLoad_, np.ones(nSmooth)) / nSmooth
        # DeltaP_ = np.convolve(DeltaP_, np.ones(nSmooth)) / nSmooth

        # data.append([PID_F_, PID_V_, DeltaF_, DeltaV_, DeltaLoad_, Frequency_, Voltage_])
        data.append([PID_F_, PID_V_, DeltaF_, DeltaV_, DeltaLoad_, DeltaP_, Frequency_, Voltage_])
    data = np.array(data)
...
if __name__ == '__main__':
    ...
    #     #     plt.legend()
    #     #
    #     #     plt.subplot(9, nTest, 1 + i + nTest * 1)
    #     #     plt.plot(x, Real1[i * len_test:(i + 1) * len_test, 0, 1], label="PID_V_real")
    #     #     plt.plot(x, Preds1[i * len_test:(i + 1) * len_test, 0, 1], label='PID_V_')
    #     #     plt.legend()
    #     #
    #     #     plt.subplot(9, nTest, 1 + i + nTest * 2)
    #     #     plt.plot(x, Real1[i * len_test:(i + 1) * len_test, 0, 2], label="DeltaF_real")
    #     #     plt.plot(x, Preds1[i * len_test:(i + 1) * len_test, 0, 2], label="DeltaF_")
    #     #     plt.legend()
    #     #
    #     #     plt.subplot(9, nTest, 1 + i + nTest * 3)
    #     #     plt.plot(x, Real1[i * len_test:(i + 1) * len_test, 0, 3], label="DeltaV_real")
    #     #     plt.plot(x, Preds1[i * len_test:(i + 1) * len_test, 0, 3], label="DeltaV_")
    #     #     plt.legend()
    #     #
    #     #     plt.subplot(9, nTest, 1 + i + nTest * 4)
    #     #     plt.plot(x, Real1[i * len_test:(i + 1) * len_test, 0, 4], label="DeltaLoad_real")
    #     #     plt.plot(x, Preds1[i * len_test:(i + 1) * len_test, 0, 4], label="DeltaLoad_")
    #     #     plt.legend()
    #     #
    #     #     plt.subplot(9, nTest, 1 + i + nTest * 5)
    #     #     plt.plot(x, Real1[i * len_test:(i + 1) * len_test, 0, 5], label="DeltaP_real")
    #     #     plt.plot(x, Preds1[i * len_test:(i + 1) * len_test, 0, 5], label="DeltaP_")
    #     #     plt.legend()
    #     #
    #     #     plt.subplot(9, nTest, 1 + i + nTest * 6)
    #     #     plt.plot(x, Real1[i * len_test:(i + 1) * len_test, 0, 6], label="Frequency_real")
    #     #     plt.plot(x, Preds1[i * len_test:(i + 1) * len_test, 0, 6], label="Frequency_")
    #     #     plt.legend()
    #     #
    #     #     plt.subplot(9, nTest, 1 + i + nTest * 7)
    #     #     plt.plot(x, Real1[i * len_test:(i + 1) * len_test, 0, 7], label="Voltage_real")
    #     #     plt.plot(x, Preds1[i * len_test:(i + 1) * len_test, 0, 7], label="Voltage_")
    #     #     plt.legend()
    #     #
    #     #     plt.subplot(9, nTest, 1 + i + nTest * 8)
    ...
    #
    #
    #     save_filename = 'power_system_random.xls'
    ...
    #         
    #
    #         save_filename = 'power_system'+str(Reservoir_node_num) + '.xls'
    #         save_results(save_filename, Preds1, Real1, data_test_label, thresholds, precisions, recalls, best_f1_score, best_f1_score_index, Loss_test)
    ...
    save_filename = 'power_system.xls'
    ...
    print("Results save to power_system.xls")